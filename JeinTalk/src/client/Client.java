...
public class Client {
	...
	public static void main(String[] args) throws SQLException {
		ConnectionPool cp = ConnectionPool.getInstance("jdbc:mariadb://192.168.0.227:3306/jeintalk", "root", "245134",
				5, 10);
		// =====================================Swing=====================================
							...
							try {
								...
								if (client.isConnected() == true) {
									...
									if (textField.getText().equals(getIdFromDb)
										...
										ChatRoom chatroom = new ChatRoom(getIdFromDb, getUserNameFromeDb, loginDate, ip,
												port, cp);
								...
								alertMessage.setText("IP및 Port를 확인해주세요.");
							} catch (Exception e1) {
								e1.printStackTrace();
							} finally {
								// connection 반환
								try {
									if (cp != null && pstmt != null && result != null) {
